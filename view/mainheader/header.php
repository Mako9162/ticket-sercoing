...
<header class="site-header">
	    <div class="container-fluid">
	        ...
	        <a href="#" class="site-logo">
	            <img class="hidden-md-down" src="../../public/img/Logo1_Innovacion.png" alt="">
	            <img class="hidden-lg-up" src="../../public/img/Icono.ico" alt="">
	        </a>
	                ...
	                <div class="site-header-shown">
	                    <div class="dropdown user-menu">
	                        ...
	                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dd-user-menu">
	                            <a class="dropdown-item" href="../mtperfil/"><span class="font-icon glyphicon glyphicon-user"></span>Perfil</a>
	                            <a class="dropdown-item" href="../ayuda/"><span class="font-icon glyphicon glyphicon-question-sign"></span>Ayuda</a>
